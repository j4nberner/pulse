...
class GRUModel(PulseTemplateModel, nn.Module):
    ...
    def __init__(self, params: Dict[str, Any], **kwargs) -> None:
        ...
        self.model_name = params.get("model_name", self.__class__.__name__.replace("Model", ""))
        ...
        self.early_stopping = self.EarlyStopping(
            patience=self.params["earlystopping_patience"], 
            verbose=True
        )
    ...
    def create_network_with_input_shape(self, input_dim: int) -> None:
        ...
        logger.info(f"GRU network initialized with input_dim {input_dim}, " +
