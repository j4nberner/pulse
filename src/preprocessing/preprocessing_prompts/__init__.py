...
from .zhu_2024_is_larger_always_better.zhu_2024_is_larger_always_better import (
...
preprocessor_method_dict = {
    ...
    "zhu_2024_is_larger_always_better_preprocessor": zhu_2024_is_larger_always_better_preprocessor,
